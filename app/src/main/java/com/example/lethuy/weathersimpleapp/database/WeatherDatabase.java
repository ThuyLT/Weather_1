...
public class WeatherDatabase implements Serializable {
    ...
    public WeatherDatabase(double id, String temp, String temp_min,
	  String temp_max, String humidity, double pressure, String description,
	  String icon, String time, String date) {
